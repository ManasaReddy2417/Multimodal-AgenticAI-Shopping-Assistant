...
def describe_product_image(image_path: str) -> str:
    ...
    message = HumanMessage(
        content=[
            ...
            {
                "type": "text",
                # In describe_product_image tool, change the text prompt to:
                "text": (
                    "Look at this product image and extract its key attributes. "
                    "Return ONLY a JSON object with these fields:\n"
                    "- product_type (e.g. 'honey', 'oats', 'almonds' — ONE or TWO words max, the generic product name)\n"
                    "- search_query (same as product_type, single generic keyword only)\n"
                    "- is_organic (true/false based on visible packaging)\n"
